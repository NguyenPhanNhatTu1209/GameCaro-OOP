...
namespace CO_CARO_2
{
    class C_DieuKhien
    {
        ...
        //chơi với máy
        public void choiVoiMay0(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 0;
            //random lượt đi
        ...
        public void choiVoiMay1(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 1;
            //random lượt đi
        ...
        public void choiVoiMay2(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 2;
            //random lượt đi
        ...
        public void choiVoiMay3(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 3;
            //random lượt đi
        ...
        public void choiVoiMay4(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 4;
            //random lượt đi
        ...
        public void choiVoiMay5(Graphics g)
        {
            //chơi với máy
            _cheDoChoi = 5;
            //random lượt đi
                    ...
                    for (int i = 0; i < BanCo.SoDong; i++)
                    {
                        for (int j = 0; j < BanCo.SoCot; j++)
                        {
                            ...
                            if (MangOCo[i, j].SoHuu == 0 && !catTia(MangOCo[i, j]))
                            {
                                ...
                                DiemTanCong = duyetTC_Ngang(i, j);
                                DiemPhongNgu = duyetPN_Ngang(i, j);
                    ...
                    for (int i = 0; i < BanCo.SoDong; i++)
                    {
                        for (int j = 0; j < BanCo.SoCot; j++)
                        {
                            ...
                            if (MangOCo[i, j].SoHuu == 0 && !catTia(MangOCo[i, j]))
                            {
                                ...
                                DiemTanCong = duyetTC_Ngang(i, j) + duyetTC_Doc(i, j);
                                DiemPhongNgu = duyetPN_Ngang(i, j) + duyetPN_Doc(i, j);
        ...
        public void mayDanh2(Graphics g)
        {
            int DiemMax = 0;
            int DiemPhongNgu = 0;
            int DiemTanCong = 0;
                    ...
                    for (int i = 0; i < BanCo.SoDong; i++)
                    {
                        for (int j = 0; j < BanCo.SoCot; j++)
                        {
                            ...
                            if (MangOCo[i, j].SoHuu == 0 && !catTia(MangOCo[i, j]))
                            {
                                ...
                                DiemTanCong = duyetTC_Ngang(i, j) + duyetTC_Doc(i, j) + duyetTC_CheoXuoi(i, j) ;
                                DiemPhongNgu = duyetPN_Ngang(i, j) + duyetPN_Doc(i, j) + duyetPN_CheoXuoi(i, j) ;
        ...
        public void mayDanh3(Graphics g)
        {
            int DiemMax = 0;
            int DiemPhongNgu = 0;
            int DiemTanCong = 0;
                    ...
                    for (int i = 0; i < BanCo.SoDong; i++)
                    {
                        for (int j = 0; j < BanCo.SoCot; j++)
                        {
                            ...
                            if (MangOCo[i, j].SoHuu == 0 && !catTia(MangOCo[i, j]))
                            {
                                ...
                                if (DiemPhongNgu+30 > DiemTanCong)
                                {
                                    DiemTam = DiemPhongNgu;
                                }
                                else
        ...
        public void mayDanh4(Graphics g)
        {
            int DiemMax = 0;
            int DiemPhongNgu = 0;
            int DiemTanCong = 0;
                    ...
                    for (int i = 0; i < BanCo.SoDong; i++)
                    {
                        for (int j = 0; j < BanCo.SoCot; j++)
                        {
                            ...
                            if (MangOCo[i, j].SoHuu == 0 && !catTia(MangOCo[i, j]))
                            {
                                ...
                                if (DiemPhongNgu >= DiemTanCong+10)
                                {
                                    DiemTam = DiemPhongNgu;
                                }
                                else
        ...
        public void mayDanh5(Graphics g)
        {
            int DiemMax = 0;
            int DiemPhongNgu = 0;
            int DiemTanCong = 0;
        ...
        public bool kiemTraChienThang1(Graphics g)
        {
            if (_stkCacNuocDaDi.Count != 0)
            {
                foreach (C_OCo oco in _stkCacNuocDaDi)
